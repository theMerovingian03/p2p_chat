                    ...
                    <form onSubmit={handleSubmit} className="w-full max-w-md p-6 text-white">
                        <div className="flex w-full flex-col">
                            ...
                            <div className="flex flex-col space-y-2 p-2 text-sm">
                                ...
                                <input id="identifier" type="identifier" value={identifier} onChange={(e) => setIdentifier(e.target.value)} required className="rounded-bl-2xl border-b border-l p-1 pb-2 pl-2 focus:outline-0" />
